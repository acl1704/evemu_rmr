...
SystemManager::~SystemManager() {
	bubbles.clear();	//just to prevent accidental deletion later, since it has a ref to all the entities we are about to delete.
	...
	std::map<uint32, SystemEntity *>::iterator cur, end;
